...
def main_attack_test():
    ...
    print(f"Accuracy of ResNet50 after attack on adversarial examples: {accuracy * 100:.2f}%")
    logging.info(f"Accuracy of ResNet50 after attack on adversarial examples: {accuracy * 100:.2f}%")
